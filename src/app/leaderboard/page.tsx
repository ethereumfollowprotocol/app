...
const LeaderboardPage = ({
  ...
  return (
    <main className='font-sans mx-auto flex h-full min-h-full w-full flex-col items-center overflow-scroll mb-12 px-4 pt-6 mt-[108px] sm:mt-28 lg:mt-32 xl:mt-40 text-center'>

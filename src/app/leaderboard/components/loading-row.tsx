    ...
    <div className='flex flex-col'>
      <div className='flex items-center w-full gap-4 p-2 sm:p-4 rounded-xl sm:gap-6 md:gap-8 h-[75px]'>
        ...
        >
          <div
            className={cn(
              'flex-col items-center hidden lg:flex gap-1 w-1/2 lg:w-1/3',
          ...
          <div
            className={cn(
              'hidden sm:flex flex-col items-center gap-1 w-1/2 lg:w-1/3 xl:w-1/4',
              isHome && 'xl:hidden 2xl:flex'
            )}
          >
            <LoadingCell className='w-10 h-6 rounded-lg' />
            {staticStats ? (
          ...
          <div
            className={cn(
              'hidden md:flex flex-col items-center gap-1 w-1/2 lg:w-1/3 xl:w-1/4',
              isHome && 'xl:hidden'
            )}
          >
            <LoadingCell className='w-10 h-6 rounded-lg' />

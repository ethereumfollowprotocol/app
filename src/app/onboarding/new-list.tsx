...
export function CreateNewListForm() {
  ...
  return (
    <Flex justify='center' mx='auto' className='max-w-4xl'>
      <Card
        variant='surface'
        mx='auto'
        my='2'
        className='max-w-[450px] w-[450px] py-2 text-center rounded-4xl'
      >
        <Box>
              ...
              {storeLocation.map((location, index) => (
                <li
                  ...
                  className={clsx([
                    ...
                    Number(storageLocation) === location.chainId ? 'bg-lime-100' : 'bg-transparent'
                  ])}
                >
                  <Button
        ...
        <Flex justify='between' mx='7' className=''>
          <Button
            disabled={step === '0'}
            onClick={event => {
          ...
          <Button
            onClick={async event => {
              ...
              if (step === '1' && simulateMintData?.request) {
                ...
                await writeMintAsync(simulateMintData.request)
              }
              updateStep('right')
            }}
            size='4'

...
export default function EditorPage() {
  return (
    <main
      ...
      className="flex flex-col-reverse xl:flex-row gap-4 min-h-full xl:h-screen xl:overflow-hidden w-full items-center xl:items-start xl:justify-center text-center"
    >
      <Cart />
    </main>
  );

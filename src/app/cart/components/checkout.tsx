...
const Checkout: React.FC<CheckoutProps> = ({ setOpen, hasCreatedEfpList }) => {
  ...
  return (
    <div className='flex glass-card gap-6 flex-col w-full sm:w-[552px] items-center border-[3px] border-zinc-100 dark:border-zinc-500 text-center justify-between rounded-xl p-6 py-8 sm:p-16'>

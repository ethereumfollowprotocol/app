...
const FollowerList = () => {
  ...
  return (
    <div className='flex flex-col lg:flex-row-reverse gap-10 lg:gap-40 xl:gap-52 items-center relative'>
      <div className='flex glass-card flex-col text-3xl z-20 md:text-4xl items-center lg:items-start lg:text-5xl xl:text-6xl font-bold gap-1 sm:gap-2 lg:gap-4 py-4 px-9 lg:px-8  lg:py-6 border-[3px] border-[#aaaaaa] rounded-2xl'>

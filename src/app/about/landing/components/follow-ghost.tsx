...
const FollowGhost = () => {
  ...
  return (
    <div className='flex flex-col lg:flex-row gap-[52px] lg:gap-16 xl:gap-40 items-center relative'>
      <div className='text-3xl flex flex-col md:text-3xl glass-card lg:text-5xl z-20 lg:items-start items-center xl:text-6xl font-bold w-fit p-4 gap-2 lg:px-8 lg:py-[22px] border-[3px] border-[#aaaaaa] rounded-2xl'>

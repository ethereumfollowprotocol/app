...
const SocialGraph = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row-reverse gap-8 lg:gap-[90px] xl:gap-32 items-center relative">
      <div className="text-3xl flex lg:items-start items-center flex-col gap-1 lg:gap-3 z-20 md:text-4xl lg:text-5xl xl:text-6xl glass-card font-bold px-4 py-4 lg:px-5 lg:py-5 border-[3px] border-[#aaaaaa] rounded-2xl">

...
const UserPage = ({ params }: Props) => {
  return (
    <main className='flex pb-8 overflow-hidden h-full w-full justify-between xl:justify-center gap-y-4 flex-col md:flex-row flex-wrap xl:flex-nowrap items-start xl:gap-6 mt-[108px] sm:mt-28 md:mt-32 xl:mt-0 px-4 lg:px-8'>

        ...
        <div className='flex gap-4 justify-between items-center w-full'>
          ...
          <div className='flex gap-4'>
            ...
            >
              ...
              {showSort && (
                <div className=' bg-white/80 glass-card p-1 gap-1 z-50 shadow-md border-[3px] rounded-md border-gray-100 dark:border-gray-500 absolute top-[120%] flex flex-col items-center right-0'>
                  {SORT_OPTIONS.map(option => (
                    <div
                      className='font-bold capitalize w-full text-nowrap relative rounded-md hover:bg-slate-100 dark:hover:bg-gray-400/60 transition-colors p-3 pl-8 text-darkGrey hover:text-darkGrey'
                      key={option}

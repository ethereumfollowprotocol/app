...
const LanguageSelector = ({ setExternalLanguageMenuOpen, setParentOpen }: LanguageSelectorProps) => {
  ...
  const clickAwayLanguageRef = useClickAway<HTMLDivElement>(() => closeLanguageMenu())
  ...
  return (
    <div ref={clickAwayLanguageRef} className="w-full cursor-pointer group relative">
      ...
      <div
        className={`-right-[251px] -top-[56px] lg:-top-[6px] absolute lg:right-[95%] z-50 ${languageMenOpenu ? 'block' : 'hidden top-0'

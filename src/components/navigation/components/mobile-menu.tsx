...
const MobileMenu: React.FC<MobileMenuProps> = ({ open, setOpen }) => {
  ...
  return (
    <div className=' bg-white/90  glass-card px-3 py-2 gap-1 z-50 shadow-md border-[3px] rounded-md border-gray-200 absolute top-[120%] flex flex-col items-end right-0'>
      {NAV_ITEMS.map(item => (

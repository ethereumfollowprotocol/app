...
const MobileMenu: React.FC<MobileMenuProps> = ({ open, setOpen }) => {
  ...
  return (
    <div className='bg-white dark:bg-darkGrey glass-card p-1 gap-1 z-50 shadow-md border-[3px] rounded-md border-zinc-200 dark:border-zinc-500 absolute top-[120%] flex flex-col items-end right-0'>
      {NAV_ITEMS.map(item => (

...
const EthBalance: React.FC<EthBalanceProps> = ({ address, chain }) => {
  ...
  return (
    <>
      <div className='glass-pseudo-item hover:bg-nav-item flex w-full items-center justify-between rounded-sm p-4 transition-all sm:flex-row-reverse'>
      ...
      <Link
        ...
        target='_blank'
        className='glass-pseudo-item hover:bg-nav-item text-text flex w-full items-center justify-between rounded-sm p-4 font-bold capitalize transition-all sm:flex-row-reverse'
      >

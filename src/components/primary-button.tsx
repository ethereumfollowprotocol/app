    ...
    return (
      <button
        ...
        className={clsx(
          ...
          'text-darkGrey relative rounded-full font-semibold text-lg transition-all hover:scale-110 hover:opacity-85 disabled:cursor-not-allowed disabled:after:absolute disabled:after:w-full disabled:after:h-full disabled:after:top-0 disabled:after:left-0 disabled:after:bg-gray-400/50 disabled:after:rounded-full disabled:hover:opacity-100',
          className
        )}
        {...props}
      >

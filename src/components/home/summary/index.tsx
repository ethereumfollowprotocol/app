...
const Summary = () => {
  ...
  return (
    <div className='mt-[108px] relative md:mt-32 w-full lg:mt-32 xl:mt-40 px-4 xl:px-0 2xl:px-8 flex items-start lg:justify-center lg:gap-4 xl:justify-center justify-center flex-wrap xl:flex-nowrap gap-y-4'>
      {userAddress && (
        <UserProfileCard

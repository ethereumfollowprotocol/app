...
const LatestFollowers: React.FC<LatestFollowersProps> = ({ profiles, isLoading }) => {
  ...
  return (
    <div className='glass-card lg:max-h-[638px] w-full lg:w-[49%] xl:w-[450px] 2xl:w-108 px-2 py-4 sm:p-4 flex flex-col gap-4 rounded-2xl border-[3px] border-gray-100 dark:border-gray-500'>

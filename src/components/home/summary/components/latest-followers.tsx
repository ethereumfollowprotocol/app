...
const LatestFollowers = () => {
  ...
  return (
    <div className='glass-card w-full lg:w-[49%] xl:w-[450px] 2xl:w-108 px-2 py-4 sm:p-4 flex flex-col gap-4 rounded-2xl border-[3px] border-zinc-200 dark:border-zinc-500'>

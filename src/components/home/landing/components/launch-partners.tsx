...
import Line from 'public/assets/lines/line-5.svg'
import EnsDao from 'public/assets/sponsors/ensdao.png'

const LaunchPartners = () => {
  return (
    <div className='flex flex-col gap-14 relative'>
      <div className='glass-card sm:p-8 md:p-10 border-2 border-[#FF79C9] p-4 text-black font-bold text-center text-sm rounded-3xl mx-auto w-full max-w-4xl'>
      ...
      <Image
        ...
        width={3}
        height={154}
        className='absolute top-[1537px] left-[450px]'
      />

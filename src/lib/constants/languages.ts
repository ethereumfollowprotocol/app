...
import WalesFlag from 'public/assets/icons/flags/wales.svg'
...
import MexicoFlag from 'public/assets/icons/flags/mexico.svg'
...
import MongoliaFlag from 'public/assets/icons/flags/mongolia.svg'
...
export const LANGUAGES = [
  ...
  { language: 'Español (MX)', key: 'esmx', icon: MexicoFlag, englishLanguage: 'Spanish (Mexican)' },
  ...
  { language: 'Português (BR)', key: 'ptbr', icon: BrazilFLag, englishLanguage: 'Portuguese (Brazilian)' },
